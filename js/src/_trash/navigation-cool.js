...
// By default, the first element is the trigger and the second is the target
...
(function($) {
    $.fn.dropnav = function(options) {
        ...
        var show = function(el) {
            ...
            $(el).find(settings.selector+':eq(0)').addClass(settings.open);
        }
        ...
        var hide = function(el) {
            ...
            $(el).find(settings.selector+':eq(0)').removeClass(settings.open);
        }
